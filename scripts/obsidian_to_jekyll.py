...
from scripts.version_control.cms_helper import write_last_updated, write_last_commit_message
...
class ObsidianToJekyllConverter:
    ...
    IGNORED_FRONTMATTER_FILES = ['index.md', 'home.md', 'journey.md', 'community.md', 'playground.md']
    SECTION_FOLDERS = ['journey', 'community', 'playground']
...
def main():
    ...
    last_updated_yaml = output_location / "_data" / "last_updated.yml"
    write_last_updated(repo_path=".", output_path=last_updated_yaml, recreate_directory=True)
    write_last_commit_message(repo_path=".", output_path=last_updated_yaml)
    converter.run()
